...
class VariantGraphTests(unittest.TestCase):
    ...
    def test_qwen_family_configs_are_graph_ready(self) -> None:
        ...
        self.assertEqual(
            ancestry(qwen36, "local_ft_abli_heretic_trial12_refusal_preference_unlikelihood_v11_strict_redirect"),
            [
                "base",
                "local_ft_v4",
        ...
        self.assertEqual(
            ancestry(qwen36, "local_ft_abli_heretic_trial12_refusal_preference_unlikelihood_v12_refusal_wording_hard_negatives"),
            [
                "base",
                "local_ft_v4",
                "local_ft_abli_heretic_residual_trial12",
