...
- For FT data iteration, use `./forge data plan|pack <family> <variant>` before
  editing training configs. The local FT v1 seed pack is deterministic and does
  not run teacher-model generation or upload artifacts.
