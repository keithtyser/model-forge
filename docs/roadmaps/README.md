...
This directory holds long-form planning documents and archived research
roadmaps. Keep short current-state handoff material in `docs/status.md` and
experiment-specific history in `docs/experiment-ledger.md`.
