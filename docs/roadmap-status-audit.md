...
| MF-0200 | P0: Serving | tested | smoke_validated | Add generic cluster inventory planner and DGX Spark x2 example |
...
| MF-0802 | P2: Kernel/perf | not_started | planned | Add profile summarizer |
