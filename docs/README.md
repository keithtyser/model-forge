...
Use this index by task. The top-level [README](../README.md) is the shortest
orientation path.

## New Model

- [Adding Model Family](adding-model-family.md)
- [Evaluation Strategy](evaluation-strategy.md)
- [Run Manifests](run-manifests.md)
- [Variant Graph](variant-graph.md)

## Post-Training

- [Fine-Tuning](finetuning.md)
- [Abliteration](abliteration.md)
- [Quantization](quantization.md)
- [Hugging Face Publishing](huggingface-publishing.md)

## DGX Spark

- [DGX Spark Rules](dgx-spark.md)
- [Cluster](cluster.md)
...
- [Upstream PRs](upstream-prs.md)

## Planning

- [Agent Experiments](agent-experiments.md)
- [SOTA Research Snapshot](research/sota-2026-05-18.md)
