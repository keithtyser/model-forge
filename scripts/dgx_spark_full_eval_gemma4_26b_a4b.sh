...
RUN_NAME=${MODEL_FORGE_RUN_NAME:-gemma4_26b_a4b_${MODEL_FORGE_VARIANT}_dgx_spark}

./scripts/run_dgx_spark_eval.sh configs/experiments/gemma4_26b_a4b_v0.yaml "$RUN_NAME"
